...
export APP_CURRENCY=${APP_CURRENCY:-'CNY'}
...
./
envsubst '${APP_NAME} ${APP_DESCIPTION} ${PUBLIC_APP_URL} ${APP_CURRENCY} ${APP_CURRENCY_SYMBOL} ${APP_SECURE_PATH}' < /www/server/v2board.php.tpl > /www/config/v2board.php
